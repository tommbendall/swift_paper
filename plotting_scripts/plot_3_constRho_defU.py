...
title = r'Test 2: Constant $\rho$, Deformational $u$'
...
contour_dict = {'rho': np.linspace(0.99, 1.01, 11),
        ...
        for j, (results_opt, config_title) in \
            ...
            if field_name == 'rho':
                ...
                _ = plot_field_quivers(ax, new_coords_X, new_coords_Y, field_data_X, field_data_Y,
                                       scale=25, minlength=vector_magnitude_cutoff,
            ...
            if i == len(field_names)-1:
                ax.text(6.0,-1.8, config_title, fontsize=20,
