...
\end{align}
\end{subequations}
%Note that there is flexibility in how the advective inner step is performed - see Appendix \ref{sec:cosmic_appendix} for an alternative formulation. 
...
%\section{Alternative Consistent COSMIC} \label{sec:cosmic_appendix}

%Another approach to consistent COSMIC tracer transport would be to use the density field in the inner step, which follows on from the approach of \citet{skamarock2006limiters}.
...
%\section{Stability of the One-Dimensional Conservative Tracer Scheme} \label{sec:tracer_stability_appendix}
